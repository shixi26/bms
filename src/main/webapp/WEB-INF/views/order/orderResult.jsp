...
<body>
	...
	<table class="list_view">
		<tbody align=center>
			...
			<tr>
			    <td> ${goodsInfo.orderId }</td>
				<td class="goods_image">
				  <a href="${contextPath}/goods/goodsDetail.do?goodsId=${goodsInfo.goodsId }">
					<img width="75" alt=""  src="${contextPath}/thumbnails.do?goodsId=${goodsInfo.goodsId}&fileName=${goodsInfo.goodsFileName}">
				  </a>
				</td>
				<td><h2><a href="${contextPath}/goods/goodsDetail.do?goodsId=${goodsInfo.goodsId }">${goodsInfo.goodsTitle }</a></h2></td>
				<td><h2>${goodsInfo.orderGoodsQty }개</h2></td>
				<td><h2>${goodsInfo.orderGoodsQty * goodsInfo.goodsSalesPrice}원</h2></td>
				<td><h2>${goodsInfo.goodsDeliveryPrice}원</h2></td>
				<td><h2>${1500 * goodsInfo.orderGoodsQty }원</h2></td>
				<td><h2>${goodsInfo.orderGoodsQty * goodsInfo.goodsSalesPrice + goodsInfo.goodsDeliveryPrice} 원</h2></td>
			</tr>
		</tbody>
	</table>
	<div class="clear"></div>
